...
## RESULT: 
Linear and circular convolution operations for the given sequences were successfully implemented and executed using SCILAB. The output waveforms for both methods were obtained and verified.
